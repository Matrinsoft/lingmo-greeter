...
impl UserData {
    ...
    pub fn load_config_as_user(&mut self) {
        ...
        match cosmic_config::Config::new("com.lingmoos.LingmoComp", CosmicCompConfig::VERSION) {
            Ok(config_handler) => {
        ...
        match cosmic_config::Config::new("com.lingmoos.LingmoAppletTime", TimeAppletConfig::VERSION)
        {
