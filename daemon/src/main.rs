...
#[zbus(prefix = "com.lingmoos.LingmoGreeter")]
enum GreeterError {
    #[zbus(error)]
    ZBus(zbus::Error),
    Ron(String),
...
#[zbus::interface(name = "com.lingmoos.LingmoGreeter")]
impl GreeterProxy {
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let _conn = Builder::system()?
        .name("com.lingmoos.LingmoGreeter")?
        .serve_at("/com/lingmoos/LingmoGreeter", GreeterProxy)?
        .build()
        .await?;
